 ...
 */
declare function schemaModelBuilder(model: import("../../typeDefs/schema").model, fields: import("../../typeDefs/field").fields, options?: import("../../typeDefs/schema").schema): schemaBuilder;
